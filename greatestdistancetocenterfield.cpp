#include "greatestdistancetocenterfield.h"
#include "./ui_greatestdistancetocenterfield.h"
#include <vector>
#include <string>
//need to include "team" class
#include <dbmanager.h>

void greatestDistanceToCenterField::greatestDistance(){
...
greatestDistanceToCenterField::greatestDistanceToCenterField(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::greatestDistanceToCenterField)
{
    ui->setupUi(this);
}

greatestDistanceToCenterField::~greatestDistanceToCenterField()
{
    delete ui;
}
