#include "leastdistancetocenterfield.h"
#include "./ui_leastdistancetocenterfield.h"
#include <vector>
#include <string>
//need to include "team" class
#include <dbmanager.h>

void leastDistanceToCenterField::leastDistance(){
...
leastDistanceToCenterField::leastDistanceToCenterField(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::leastDistanceToCenterField)
{
    ui->setupUi(this);
}

leastDistanceToCenterField::~leastDistanceToCenterField()
{
    delete ui;
}
